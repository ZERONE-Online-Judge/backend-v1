...
- `verification-ai-worker`: shared GPT analysis of verification verdict mismatches; configure `OPENAI_API_KEY` in `deploy/env/backend.env`. See [configuration, cache and troubleshooting](../docs/verification-ai.md).
