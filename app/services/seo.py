...
CORE_PAGES = {
    ...
    "/judge-status": {
        "title": "채점 서버 상태 | ZOJ",
        "heading": "채점 서버 상태",
        "description": "ZOJ의 공개 채점 서버 상태를 확인하세요. 활성 채점 노드와 실행 중인 작업, 대기 중인 제출 현황이 주기적으로 갱신됩니다.",
        "paragraphs": ["현재 채점 서버의 상태와 실행 중인 작업, 대기열 현황을 확인할 수 있습니다. 채점 상태는 주기적으로 갱신됩니다."],
    },
    "/support": {
